...
Auto-generated by scripts/generate_module_packages.py on 2026-06-09 14:38:54
"""
...
MODULE_PACKAGES = {
    ...
    ("log4j", 8, "2"): {"log4j", "jctools", "log4j-jcl", "log4j-slf4j", "disruptor", "log4j-web"},
    ...
    ("redis", 8, "5"): {"redis-devel", "redis", "redis-doc"},
    ("redis", 8, "6"): {"redis-devel", "redis", "redis-doc"},
    ("rhn-tools", 8, "1.0"): {
        "cobbler",
        "koan",
        "osad",
    ...
    ("squid", 8, "4"): {"libecap-devel", "libecap", "squid"},
    ("subversion", 8, "1.10"): {
        "libserf",
        "mod_dav_svn",
        "subversion",
    ...
    ("swig", 8, "3.0"): {"swig", "swig-gdb", "swig-doc"},
    ("swig", 8, "4.0"): {"swig", "swig-gdb", "swig-doc"},
    ("swig", 8, "4.1"): {"swig", "swig-gdb", "swig-doc"},
    ("varnish", 8, "6"): {"varnish-docs", "varnish-modules", "varnish", "varnish-devel"},
    ("virt", 8, "rhel"): {
        "hivex",
        "hivex-devel",
        "libguestfs",
    ...
    ("redis", 9, "7"): {"redis-devel", "redis", "redis-doc"},
    ("ruby", 9, "3.1"): {
        "ruby",
        "ruby-bundled-gems",
        "ruby-default-gems",
