...
OS_LIFECYCLE_DATES = {
    ...
    "10.4": RHELLifecycle(
        major=10,
        minor=4,
        start_date=date(2027, 5, 30),
        end_date=date(2027, 11, 15),
        end_date_eus=date(2029, 5, 30),
        end_date_e4s=date(2031, 5, 30),
    ),
    "10.5": RHELLifecycle(
        major=10,
        minor=5,
    ...
    "11.3": RHELLifecycle(
        major=11,
        minor=3,
        start_date=date(2029, 11, 15),
        end_date=date(2030, 5, 30),
    ),
    "11.4": RHELLifecycle(
        major=11,
        minor=4,
        start_date=date(2030, 5, 30),
        end_date=date(2030, 11, 15),
        end_date_eus=date(2032, 5, 30),
        end_date_e4s=date(2034, 5, 30),
    ),
    "11.5": RHELLifecycle(
        major=11,
        minor=5,
        start_date=date(2030, 11, 15),
    ...
    "11.6": RHELLifecycle(
        ...
        end_date=date(2031, 11, 1),
        end_date_eus=date(2033, 5, 31),
        end_date_e4s=date(2035, 5, 31),
    ),
    "11.7": RHELLifecycle(
        major=11,
        minor=7,
        start_date=date(2031, 11, 1),
        end_date=date(2032, 5, 15),
    ),
    "11.8": RHELLifecycle(
        major=11,
        minor=8,
        start_date=date(2032, 5, 15),
        end_date=date(2032, 11, 1),
        end_date_eus=date(2034, 5, 31),
        end_date_e4s=date(2036, 5, 31),
    ),
    "11.9": RHELLifecycle(
        major=11,
        minor=9,
        start_date=date(2032, 11, 1),
        end_date=date(2033, 5, 15),
    ),
    "11.10": RHELLifecycle(
        major=11,
        minor=10,
        start_date=date(2033, 5, 15),
        end_date=date(2038, 5, 31),
        end_date_els=date(2041, 5, 31),
    ),
}
