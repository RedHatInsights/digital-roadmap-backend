...
OS_LIFECYCLE_DATES = {
    "8": RHELLifecycle(
        ...
        retirement_date=date(2029, 5, 31),
    ...
    "8.0": RHELLifecycle(
        ...
        minor=0,
        release_date=date(2019, 5, 7),
        retirement_date=date(2019, 11, 30),
    ),
    "8.1": RHELLifecycle(
        major=8,
        minor=1,
        release_date=date(2019, 11, 5),
        retirement_date=date(2020, 5, 31),
        end_e4s=date(2023, 11, 30),
    ),
    "8.2": RHELLifecycle(
        major=8,
        minor=2,
        release_date=date(2020, 4, 28),
        retirement_date=date(2020, 10, 31),
    ...
    "8.3": RHELLifecycle(
        ...
        retirement_date=date(2021, 5, 31),
    ),
    "8.4": RHELLifecycle(
        major=8,
        minor=4,
        release_date=date(2021, 5, 18),
        retirement_date=date(2021, 11, 30),
    ...
    "8.5": RHELLifecycle(
        ...
        retirement_date=date(2022, 5, 31),
    ),
    "8.6": RHELLifecycle(
        major=8,
        minor=6,
        release_date=date(2022, 5, 10),
        retirement_date=date(2022, 11, 30),
    ...
    "8.7": RHELLifecycle(
        ...
        retirement_date=date(2023, 5, 31),
    ),
    "8.8": RHELLifecycle(
        major=8,
        minor=8,
        release_date=date(2023, 5, 16),
        retirement_date=date(2023, 11, 30),
    ...
    "8.9": RHELLifecycle(
        major=8,
        minor=9,
        release_date=date(2023, 11, 14),
        retirement_date=date(2024, 5, 31),
    ),
    "8.10": RHELLifecycle(
        major=8,
        minor=10,
    ...
    "9": RHELLifecycle(
        ...
        retirement_date=date(2032, 5, 31),
    ...
    "9.3": RHELLifecycle(
        major=9,
        minor=3,
        release_date=date(2023, 11, 7),
        retirement_date=date(2024, 5, 31),
    ),
    "9.4": RHELLifecycle(
        major=9,
        minor=4,
        release_date=date(2024, 4, 30),
        retirement_date=date(2024, 10, 31),
    ...
    "9.5": RHELLifecycle(
        major=9,
        minor=5,
        release_date=date(2024, 11, 12),
        retirement_date=date(2025, 5, 31),
    ),
    "9.6": RHELLifecycle(
        major=9,
        minor=6,
        release_date=date(2025, 5, 15),
        retirement_date=date(2025, 11, 30),
    ...
    "9.7": RHELLifecycle(
        ...
        retirement_date=date(2026, 5, 31),
    ),
    "9.8": RHELLifecycle(
        major=9,
        minor=8,
        release_date=date(2026, 5, 15),
        retirement_date=date(2026, 11, 30),
    ...
    "9.9": RHELLifecycle(
        major=9,
        minor=9,
        release_date=date(2026, 11, 1),
        retirement_date=date(2027, 5, 31),
    ),
    "9.10": RHELLifecycle(
        major=9,
        minor=10,
        release_date=date(2027, 5, 15),
        retirement_date=date(2032, 5, 31),
        end_els=date(2035, 5, 31),
    ),
    "10.1": RHELLifecycle(
