...
OS_LIFECYCLE_DATES = {
    ...
    "10.4": RHELLifecycle(
        ...
        end_date_eus=date(2029, 5, 31),
        end_date_e4s=date(2031, 5, 31),
    ),
    "10.5": RHELLifecycle(
        major=10,
        minor=5,
