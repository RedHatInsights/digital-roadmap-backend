...
def test_get_relevant_app_stream(api_prefix, client):
    ...
    assert count == 27, "Incorrect number of items in response. Did the fixture data change?"
    assert total == 203, "Incorrect number of hosts in response. Did the fixture data change?"
